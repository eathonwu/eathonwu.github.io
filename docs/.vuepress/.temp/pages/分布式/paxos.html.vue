...
<figure><img src="https://oscimg.oschina.net/oscnet/up-890fa3212e8bf72886a595a34654918486c.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>为了减少实现该算法所需的节点数，一个节点可以身兼多个角色。并且，一个提案被选定需要被半数以上的 Acceptor 接受。这样的话，Basic Paxos 算法还具备容错性，在少于一半的节点出现故障时，集群仍能正常工作。</p>
<h1 id="paxos-三种角色-proposer-acceptor-learners" tabindex="-1"><a class="header-anchor" href="#paxos-三种角色-proposer-acceptor-learners"><span><strong>Paxos</strong> 三种角色:<strong>Proposer</strong>，<strong>Acceptor</strong>，<strong>Learners</strong></span></a></h1>
<p><strong>Proposer</strong>:</p>
<p>只要 Proposer 发的提案被半数以上 Acceptor 接受，Proposer 就认为该提案里的 value 被选定 了。</p>
<p><strong>Acceptor</strong>:<br>
...
<p>著作权归Guide所有 原文链接：<a href="https://javaguide.cn/distributed-system/protocol/paxos-algorithm.html#%E4%BB%8B%E7%BB%8D" target="_blank" rel="noopener noreferrer">https://javaguide.cn/distributed-system/protocol/paxos-algorithm.html#介绍</a></p>
</div></template>
